...
func GetSubscriberByID(m mongoapi.MongoClient, a mongoapi.MongoClient) gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		authSubsDataInterface, _ := a.RestfulAPIGetOne(authSubsDataColl, filterUeIdOnly)
