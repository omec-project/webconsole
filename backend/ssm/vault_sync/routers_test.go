...
func TestAddSyncVaultService(t *testing.T) {
	gin.SetMode(gin.TestMode)
	engine := gin.New()

	group := AddSyncVaultService(engine)

	if group == nil {
		t.Error("AddSyncVaultService should return a RouterGroup")
	}
}

func TestAddSyncVaultServiceWithMiddlewares(t *testing.T) {
	gin.SetMode(gin.TestMode)
	engine := gin.New()
	...
	group := AddSyncVaultService(engine, testMiddleware)
