...
func StartServer(host string, confServ *ConfigServer, configMsgChan chan *configmodels.ConfigMessage, oneDeleter MongoOneDeleter, manyGetter MongoManyGetter, poster MongoPoster, oneGetter MongoOneGetter) {
	...
	go configHandler(configMsgChan, configReady, oneDeleter, manyGetter, poster, oneGetter)
	ready := <-configReady
